...
$options = array(
	'shortcode_name' => array(
		'label' => __( 'Shortcode Name', 'start' ),
		'desc'  => __( 'Enter a name (it is for internal use and will not appear on the front end)', 'start' ),
		'help'  => __( 'Use this option to name your shortcode. It will help you go through the structure a lot easier.', 'start' ),
		'type'  => 'text',
	),
	'text'           => array(
		'type'  => 'textarea',
		'value' => '',
		'label' => __( 'Code', 'start' ),
		'desc'  => __( 'Enter the HTML, JavaScript or CSS code', 'start' )
	),
	'responsive'     => array(

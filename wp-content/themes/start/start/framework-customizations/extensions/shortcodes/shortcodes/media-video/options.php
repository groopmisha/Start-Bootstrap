...
$options = array(
	'video'      => array(
		'label' => esc_html__( 'Video', 'start' ),
		'desc'  => esc_html__( 'Enter Youtube or Vimeo video URL', 'start' ),
		'type'  => 'text',
	),
	'width'      => array(
		'label' => esc_html__( 'Width', 'start' ),
		'desc'  => esc_html__( 'Video width in pixels', 'start' ),
		'type'  => 'short-text',
		'value' => '',
	),
	'responsive' => array(
